    ...
    <div class="parent" v-if="serNum >= 1">
      <div class="card" data-aos="fade-up" data-aos-delay="0">
        ...
        <div class="card-body">
          ...
          <button class="service-but" @click="openModal(t('businessSetup'))">
            {{ t("getService") }}
          </button>
        </div>
      </div>
      <div class="card" data-aos="fade-up" data-aos-delay="0">
        ...
        <div class="card-body">
          ...
          <button class="service-but" @click="openModal(t('familyVisa'))">
            {{ t("getService") }}
          </button>
        </div>
      </div>
      <div class="card" data-aos="fade-up" data-aos-delay="0">
        ...
        <div class="card-body">
          ...
          <button class="service-but" @click="openModal(t('employmentVisa'))">
            {{ t("getService") }}
          </button>
        </div>
      </div>
    ...
    <div class="parent" v-if="serNum >= 2">
      <div class="card" data-aos="fade-up" data-aos-delay="0">
        ...
        <div class="card-body">
          ...
          <button class="service-but" @click="openModal(t('goldenResidency'))">
            {{ t("getService") }}
          </button>
        </div>
      </div>
      <div class="card" data-aos="fade-up" data-aos-delay="0">
        ...
        <div class="card-body">
          ...
          <button class="service-but" @click="openModal(t('touristVisa'))">
            {{ t("getService") }}
          </button>
        </div>
      </div>
      <div class="card" data-aos="fade-up" data-aos-delay="0">
        ...
        <div class="card-body">
          ...
          <button class="service-but" @click="openModal(t('typingServices'))">
            {{ t("getService") }}
          </button>
        </div>
      </div>
    ...
    <div class="parent" v-if="serNum >= 3">
      <div class="card" data-aos="fade-up" data-aos-delay="0">
        ...
        <div class="card-body">
          ...
          <button class="service-but" @click="openModal(t('visaStamping'))">
            {{ t("getService") }}
          </button>
        </div>
      </div>
      <div class="card" data-aos="fade-up" data-aos-delay="0">
        ...
        <div class="card-body">
          ...
          <button class="service-but" @click="openModal(t('emiratesID'))">
            {{ t("getService") }}
          </button>
        </div>
      </div>
      <div class="card" data-aos="fade-up" data-aos-delay="0">
        ...
        <div class="card-body">
          ...
          <button
            class="service-but"
            @click="openModal(t('medicalExamination'))"
          >
            {{ t("getService") }}
          </button>
        </div>
